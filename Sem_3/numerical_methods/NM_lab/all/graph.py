...
oconv=[]
for i in range(len(data)):
	oconv.append((float)(data[i][0]))
	
plt.plot(oconv,color="blue",label='bisection')
...
plt.plot(oconv,color="green",label='regula falsie')
...
plt.plot(oconv,color="yellow",label='newton ralphson')
...
plt.plot(oconv,color="red",label='secant')
...
plt.plot(oconv,color="orange",label='fixed point iteration')
